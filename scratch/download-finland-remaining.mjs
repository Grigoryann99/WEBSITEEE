...
const items = [
  ...
  { search: "Museum Centre Vapriikki", file: "finland-tampere-vapriikki.jpg" },
...
function getWikiImageUrl(searchQuery) {
  return new Promise((resolve) => {
    const url = `https://en.wikipedia.org/w/api.php?action=query&titles=${encodeURIComponent(searchQuery)}&prop=pageimages&format=json&pithumbsize=960`;
...
async function main() {
  console.log("Fetching remaining Finland images...");
