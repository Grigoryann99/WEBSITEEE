                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                    {destinationCategories.map((cat, i) => (
                        <motion.div
                            ...
                            className="bg-[#141414]/90 backdrop-blur-xl border border-white/5 rounded-2xl p-6 text-center hover:border-brand-accent/30 hover:-translate-y-1 transition-all group cursor-pointer"
                        >
