...
const countryDB: Record<string, ResultCountry> = {
    ...
    newzealand:   { name: 'New Zealand',  slug: 'new-zealand',  bestSeason: 'Dec – Feb', budget: '$120 – $280/day' },
    ...
    costarica:    { name: 'Costa Rica',   slug: 'costa-rica',   bestSeason: 'Dec – Apr', budget: '$80 – $200/day' },
    ...
    southkorea:   { name: 'South Korea',  slug: 'south-korea',  bestSeason: 'Mar – May', budget: '$80 – $200/day' },
