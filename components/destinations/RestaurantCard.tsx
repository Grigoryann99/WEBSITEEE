...
export default function RestaurantCard({ name, cuisine, rating, priceLevel }: RestaurantCardProps) {
    return (
        <div className="group bg-[#1a1a1a] p-6 sm:p-8 rounded-3xl border border-white/5 transition-all duration-500 hover:border-brand-accent/30 hover:-translate-y-2 hover:shadow-xl relative overflow-hidden flex flex-col h-full">
            ...
            <div className="relative z-10 flex flex-col flex-grow">
                ...
                <div className="mt-auto">
                    ...
                    <h4 className="font-serif text-2xl text-brand-light mb-4 group-hover:text-brand-accent transition-colors duration-300">
                        {name}
                    </h4>

                    <div className="flex items-center gap-2 pt-4 border-t border-white/10">
                        <span className="text-xs tracking-widest uppercase text-brand-light/40 font-sans">Price:</span>
                        <span className="text-brand-light text-sm font-medium tracking-wider">{priceLevel}</span>
                    </div>
                </div>
            </div>
        </div>
