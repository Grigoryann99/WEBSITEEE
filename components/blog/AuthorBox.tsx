...
export default function AuthorBox() {
    return (
        <section className="mt-16 pt-10 border-t border-black/10">
            <div className="flex flex-col sm:flex-row items-start gap-6 bg-white border border-gray-200 rounded-3xl p-8 shadow-sm">
                {/* Author avatar */}
                ...
                <div className="flex-grow text-left">
                    <div className="flex items-center gap-3 mb-2">
                        <h3 className="font-serif text-xl text-brand-dark">Elena Morozova</h3>
                    ...
                    <p className="font-sans text-brand-dark/60 text-sm font-light leading-relaxed mb-4">
                    ...
                    <div className="flex items-center gap-4">
                        <Link
                            href="/about"
                            className="font-sans text-xs tracking-widest uppercase text-brand-accent hover:text-brand-dark transition-colors duration-300 inline-flex items-center gap-2"
                        >
