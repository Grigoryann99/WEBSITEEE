...
export const globalDestinations: DestinationItem[] = [
    ...
    { id: 'no', name: 'Norway', description: 'Majestic fjords, jagged mountains, and an unparalleled connection to raw nature.', image: 'https://images.unsplash.com/photo-ILYVeUgPkmI?auto=format&fit=crop&q=80&w=800' },
    { id: 'se', name: 'Sweden', description: 'Archipelagos of thousands of islands and the sophisticated design culture of Stockholm.', image: 'https://images.unsplash.com/photo-k3eAVYiHXHg?auto=format&fit=crop&q=80&w=800' },
    { id: 'fi', name: 'Finland', description: 'Lakeside saunas, pristine forests, and magical winter experiences in Lapland.', image: 'https://images.unsplash.com/photo-NlLHUJlMhjE?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'pl', name: 'Poland', description: 'Rich medieval history, resilient cities like Krakow, and deep cultural traditions.', image: 'https://images.unsplash.com/photo-2lK0291iNHI?auto=format&fit=crop&q=80&w=800' },
    { id: 'cz', name: 'Czech Republic', description: 'The gothic splendor of Prague, featuring spectacular bridges and astronomical clocks.', image: 'https://images.unsplash.com/photo-5AbNOquzKSE?auto=format&fit=crop&q=80&w=800' },
    { id: 'hu', name: 'Hungary', description: 'Thermal baths, grand architecture along the Danube, and vibrant ruin bars in Budapest.', image: 'https://images.unsplash.com/photo-4tTQPwnH8i4?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'ae', name: 'United Arab Emirates', description: 'Unprecedented modern luxury, towering skyscrapers, and opulent desert retreats.', image: 'https://images.unsplash.com/photo-Fr6zexbmjmc?auto=format&fit=crop&q=80&w=800' },
    { id: 'qa', name: 'Qatar', description: 'Futuristic skylines blending flawlessly with deep-rooted Arabian heritage and art.', image: 'https://images.unsplash.com/photo-yB154qM?auto=format&fit=crop&q=80&w=800' },
    { id: 'jo', name: 'Jordan', description: 'The incredible rose-red city of Petra and the stark, beautiful landscapes of Wadi Rum.', image: 'https://images.unsplash.com/photo-k9gOyu9K9FM?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'my', name: 'Malaysia', description: 'A melting pot of cultures featuring the Petronas Towers and pristine Bornean rainforests.', image: 'https://images.unsplash.com/photo-8ywrgMgVtlY?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'lk', name: 'Sri Lanka', description: 'Lush tea plantations, ancient Buddhist ruins, and pristine Indian Ocean beaches.', image: 'https://images.unsplash.com/photo-jpTT_SAU034?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'nz', name: 'New Zealand', description: 'Unmatched adventure landscapes, soaring fjords, and welcoming native Maori culture.', image: 'https://images.unsplash.com/photo-73F4pKoUkM0?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'mx', name: 'Mexico', description: 'Ancient Mayan ruins, vibrant culinary scenes, and stunning resorts in the Riviera Maya.', image: 'https://images.unsplash.com/photo-63mOjNg0Xu8?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'ar', name: 'Argentina', description: 'The tango culture of Buenos Aires, premium wine regions, and the dramatic peaks of Patagonia.', image: 'https://images.unsplash.com/photo-5RY2ggp0ykQ?auto=format&fit=crop&q=80&w=800' },
    { id: 'cl', name: 'Chile', description: 'From the stark beauty of the Atacama Desert to the frozen fjords of the south.', image: 'https://images.unsplash.com/photo-0V_mQncw9fM?auto=format&fit=crop&q=80&w=800' },
    { id: 'pe', name: 'Peru', description: 'The mystical ruins of Machu Picchu, the Sacred Valley, and world-renowned gastronomy.', image: 'https://images.unsplash.com/photo-yam1KMv0SgQ?auto=format&fit=crop&q=80&w=800' },
    { id: 'co', name: 'Colombia', description: 'Colorful colonial cities like Cartagena, rich coffee regions, and revitalized urban centers.', image: 'https://images.unsplash.com/photo-acH94SHbWS4?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'pa', name: 'Panama', description: 'A thriving modern capital, the famous canal, and pristine, undeveloped tropical islands.', image: 'https://images.unsplash.com/photo-qeltMhQIw3w?auto=format&fit=crop&q=80&w=800' },
    { id: 'za', name: 'South Africa', description: 'Unforgettable Big Five safaris, spectacular coastal drives, and the beauty of Cape Town.', image: 'https://images.unsplash.com/photo-FD4laNilvCU?auto=format&fit=crop&q=80&w=800' },
    { id: 'ma', name: 'Morocco', description: 'A sensory journey through colorful souks, the Sahara desert, and intricate riad architecture.', image: 'https://images.unsplash.com/photo-jnJMtXFqCFY?auto=format&fit=crop&q=80&w=800' },
