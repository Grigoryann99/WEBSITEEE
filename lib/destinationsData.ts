...
export const globalDestinations: DestinationItem[] = [
    // Europe
    { id: 'it', name: 'Italy', description: 'From the ruins of Rome to the sun-drenched Amalfi Coast, a masterpiece of culture and cuisine.', image: 'https://images.unsplash.com/photo-1516483638261-f40af5ba3081?auto=format&fit=crop&q=80&w=800' },
    { id: 'es', name: 'Spain', description: 'Vibrant cities, stunning beaches, and a passion for life wrapped in striking architecture.', image: 'https://images.unsplash.com/photo-1533676802871-eca1ae998cd5?auto=format&fit=crop&q=80&w=800' },
    { id: 'fr', name: 'France', description: 'The epitome of romance, offering world-class art in Paris and luxurious retreats in the Riviera.', image: 'https://images.unsplash.com/photo-1502602898657-3e9076bafad8?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'ch', name: 'Switzerland', description: 'Pristine alpine lakes, dramatic peaks, and unparalleled luxury mountain resorts.', image: 'https://images.unsplash.com/photo-1528901166007-3784c7dd3653?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'be', name: 'Belgium', description: 'Medieval towns, extraordinary chocolate, and the historic charm of Bruges and Brussels.', image: 'https://images.unsplash.com/photo-1562922688-4c6020c6b1d1?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'ie', name: 'Ireland', description: 'Rolling green hills, dramatic cliffs, and a uniquely welcoming Celtic culture.', image: 'https://images.unsplash.com/photo-1590054817111-2092e0df4005?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'no', name: 'Norway', description: 'Majestic fjords, jagged mountains, and an unparalleled connection to raw nature.', image: 'https://images.unsplash.com/photo-1513515579930-14e304f5e022?auto=format&fit=crop&q=80&w=800' },
    { id: 'se', name: 'Sweden', description: 'Archipelagos of thousands of islands and the sophisticated design culture of Stockholm.', image: 'https://images.unsplash.com/photo-1509356843151-3e7d96241e11?auto=format&fit=crop&q=80&w=800' },
    { id: 'fi', name: 'Finland', description: 'Lakeside saunas, pristine forests, and magical winter experiences in Lapland.', image: 'https://images.unsplash.com/photo-1538332576228-eb5b4c4de6f5?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'pl', name: 'Poland', description: 'Rich medieval history, resilient cities like Krakow, and deep cultural traditions.', image: 'https://images.unsplash.com/photo-1519965582372-246e7f8cbdbb?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'hu', name: 'Hungary', description: 'Thermal baths, grand architecture along the Danube, and vibrant ruin bars in Budapest.', image: 'https://images.unsplash.com/photo-1548678967-f1fcafae9259?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'qa', name: 'Qatar', description: 'Futuristic skylines blending flawlessly with deep-rooted Arabian heritage and art.', image: 'https://images.unsplash.com/photo-1539667468225-eebb663053e6?auto=format&fit=crop&q=80&w=800' },
    { id: 'jo', name: 'Jordan', description: 'The incredible rose-red city of Petra and the stark, beautiful landscapes of Wadi Rum.', image: 'https://images.unsplash.com/photo-1545642412-8cf0722bc1d8?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'kr', name: 'South Korea', description: 'Dynamic Seoul pop culture contrasting with tranquil mountains and historic palaces.', image: 'https://images.unsplash.com/photo-1514190890250-8b0ab978bfd8?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'lk', name: 'Sri Lanka', description: 'Lush tea plantations, ancient Buddhist ruins, and pristine Indian Ocean beaches.', image: 'https://images.unsplash.com/photo-1546708973-c15ee8d94e01?auto=format&fit=crop&q=80&w=800' },
    { id: 'mv', name: 'Maldives', description: 'The absolute pinnacle of overwater luxury resorts and exquisite turquoise lagoons.', image: 'https://images.unsplash.com/photo-1501785888041-af3ef285b470?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'mx', name: 'Mexico', description: 'Ancient Mayan ruins, vibrant culinary scenes, and stunning resorts in the Riviera Maya.', image: 'https://images.unsplash.com/photo-1512813117056-11b3e55ec706?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'cl', name: 'Chile', description: 'From the stark beauty of the Atacama Desert to the frozen fjords of the south.', image: 'https://images.unsplash.com/photo-1582697818456-4b8c650fc345?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'co', name: 'Colombia', description: 'Colorful colonial cities like Cartagena, rich coffee regions, and revitalized urban centers.', image: 'https://images.unsplash.com/photo-1583345869152-710da3f14545?auto=format&fit=crop&q=80&w=800' },
    { id: 'cr', name: 'Costa Rica', description: 'The ultimate eco-tourism destination with lush rainforests, volcanoes, and incredible wildlife.', image: 'https://images.unsplash.com/photo-1563287042-3a322797e88c?auto=format&fit=crop&q=80&w=800' },
    { id: 'pa', name: 'Panama', description: 'A thriving modern capital, the famous canal, and pristine, undeveloped tropical islands.', image: 'https://images.unsplash.com/photo-1598101458920-56543b355e1a?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'ma', name: 'Morocco', description: 'A sensory journey through colorful souks, the Sahara desert, and intricate riad architecture.', image: 'https://images.unsplash.com/photo-1539020140153-e479b8c22e70?auto=format&fit=crop&q=80&w=800' },
    { id: 'eg', name: 'Egypt', description: 'The cradle of civilization, featuring the Pyramids of Giza and luxurious Nile river cruises.', image: 'https://images.unsplash.com/photo-1539650116574-8efeb43e2b50?auto=format&fit=crop&q=80&w=800' },
];
