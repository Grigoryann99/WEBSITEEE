...
export const globalDestinations: DestinationItem[] = [
    ...
    { id: 'no', name: 'Norway', description: 'Majestic fjords, jagged mountains, and an unparalleled connection to raw nature.', image: 'https://picsum.photos/seed/norway-fjords/800/1000' },
    { id: 'se', name: 'Sweden', description: 'Archipelagos of thousands of islands and the sophisticated design culture of Stockholm.', image: 'https://picsum.photos/seed/sweden-archipelago/800/1000' },
    { id: 'fi', name: 'Finland', description: 'Lakeside saunas, pristine forests, and magical winter experiences in Lapland.', image: 'https://picsum.photos/seed/finland-lapland/800/1000' },
