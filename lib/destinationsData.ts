...
export const globalDestinations: DestinationItem[] = [
    ...
    { id: 'no', name: 'Norway', description: 'Majestic fjords, jagged mountains, and an unparalleled connection to raw nature.', image: 'https://images.unsplash.com/photo-1505312917212-9db5bde78aff?auto=format&fit=crop&q=80&w=800' },
    { id: 'se', name: 'Sweden', description: 'Archipelagos of thousands of islands and the sophisticated design culture of Stockholm.', image: 'https://images.unsplash.com/photo-1752003119242-4ab0b493afed?auto=format&fit=crop&q=80&w=800' },
    { id: 'fi', name: 'Finland', description: 'Lakeside saunas, pristine forests, and magical winter experiences in Lapland.', image: 'https://images.unsplash.com/photo-1712407886114-adddf9568a5a?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'pl', name: 'Poland', description: 'Rich medieval history, resilient cities like Krakow, and deep cultural traditions.', image: 'https://images.unsplash.com/photo-1636903364559-0dfc358abd94?auto=format&fit=crop&q=80&w=800' },
    { id: 'cz', name: 'Czech Republic', description: 'The gothic splendor of Prague, featuring spectacular bridges and astronomical clocks.', image: 'https://images.unsplash.com/photo-1735241586057-dcd5d000df97?auto=format&fit=crop&q=80&w=800' },
    { id: 'hu', name: 'Hungary', description: 'Thermal baths, grand architecture along the Danube, and vibrant ruin bars in Budapest.', image: 'https://images.unsplash.com/photo-1638131984912-96ae3d289f16?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'ae', name: 'United Arab Emirates', description: 'Unprecedented modern luxury, towering skyscrapers, and opulent desert retreats.', image: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?auto=format&fit=crop&q=80&w=800' },
    { id: 'qa', name: 'Qatar', description: 'Futuristic skylines blending flawlessly with deep-rooted Arabian heritage and art.', image: 'https://images.unsplash.com/photo-1647252262017-582a7dbb73d0?auto=format&fit=crop&q=80&w=800' },
    { id: 'jo', name: 'Jordan', description: 'The incredible rose-red city of Petra and the stark, beautiful landscapes of Wadi Rum.', image: 'https://images.unsplash.com/photo-1712323028707-6e59c3d2271a?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'my', name: 'Malaysia', description: 'A melting pot of cultures featuring the Petronas Towers and pristine Bornean rainforests.', image: 'https://images.unsplash.com/photo-1588931322123-9345cc9688bd?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'lk', name: 'Sri Lanka', description: 'Lush tea plantations, ancient Buddhist ruins, and pristine Indian Ocean beaches.', image: 'https://images.unsplash.com/photo-1566296314736-6eaac1ca0cb9?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'nz', name: 'New Zealand', description: 'Unmatched adventure landscapes, soaring fjords, and welcoming native Maori culture.', image: 'https://images.unsplash.com/photo-1465056836041-7f43ac27dcb5?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'mx', name: 'Mexico', description: 'Ancient Mayan ruins, vibrant culinary scenes, and stunning resorts in the Riviera Maya.', image: 'https://images.unsplash.com/photo-1589882868702-f0c72816f98b?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'ar', name: 'Argentina', description: 'The tango culture of Buenos Aires, premium wine regions, and the dramatic peaks of Patagonia.', image: 'https://images.unsplash.com/photo-1662217688785-b5c4424a320a?auto=format&fit=crop&q=80&w=800' },
    { id: 'cl', name: 'Chile', description: 'From the stark beauty of the Atacama Desert to the frozen fjords of the south.', image: 'https://images.unsplash.com/photo-1718587549592-a7b86daa418c?auto=format&fit=crop&q=80&w=800' },
    { id: 'pe', name: 'Peru', description: 'The mystical ruins of Machu Picchu, the Sacred Valley, and world-renowned gastronomy.', image: 'https://images.unsplash.com/photo-1580619305218-8423a7ef79b4?auto=format&fit=crop&q=80&w=800' },
    { id: 'co', name: 'Colombia', description: 'Colorful colonial cities like Cartagena, rich coffee regions, and revitalized urban centers.', image: 'https://images.unsplash.com/photo-1714686495394-73e2bb1bbd39?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'pa', name: 'Panama', description: 'A thriving modern capital, the famous canal, and pristine, undeveloped tropical islands.', image: 'https://images.unsplash.com/photo-1650900426337-0f7c0e0f86ea?auto=format&fit=crop&q=80&w=800' },
    { id: 'za', name: 'South Africa', description: 'Unforgettable Big Five safaris, spectacular coastal drives, and the beauty of Cape Town.', image: 'https://images.unsplash.com/photo-1592910725283-4a7752699e67?auto=format&fit=crop&q=80&w=800' },
    { id: 'ma', name: 'Morocco', description: 'A sensory journey through colorful souks, the Sahara desert, and intricate riad architecture.', image: 'https://images.unsplash.com/photo-1673709985879-ba098b960f27?auto=format&fit=crop&q=80&w=800' },
