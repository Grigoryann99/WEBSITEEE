...
export const globalDestinations: DestinationItem[] = [
    ...
    { id: 'no', name: 'Norway', description: 'Majestic fjords, jagged mountains, and an unparalleled connection to raw nature.', image: 'https://source.unsplash.com/ILYVeUgPkmI/800x1000' },
    { id: 'se', name: 'Sweden', description: 'Archipelagos of thousands of islands and the sophisticated design culture of Stockholm.', image: 'https://source.unsplash.com/cEpMf_BPDUs/800x1000' },
    { id: 'fi', name: 'Finland', description: 'Lakeside saunas, pristine forests, and magical winter experiences in Lapland.', image: 'https://source.unsplash.com/NlLHUJlMhjE/800x1000' },
    ...
    { id: 'pl', name: 'Poland', description: 'Rich medieval history, resilient cities like Krakow, and deep cultural traditions.', image: 'https://source.unsplash.com/2lK0291iNHI/800x1000' },
    { id: 'cz', name: 'Czech Republic', description: 'The gothic splendor of Prague, featuring spectacular bridges and astronomical clocks.', image: 'https://source.unsplash.com/5AbNOquzKSE/800x1000' },
    { id: 'hu', name: 'Hungary', description: 'Thermal baths, grand architecture along the Danube, and vibrant ruin bars in Budapest.', image: 'https://source.unsplash.com/4tTQPwnH8i4/800x1000' },
    ...
    { id: 'ae', name: 'United Arab Emirates', description: 'Unprecedented modern luxury, towering skyscrapers, and opulent desert retreats.', image: 'https://source.unsplash.com/Fr6zexbmjmc/800x1000' },
    { id: 'qa', name: 'Qatar', description: 'Futuristic skylines blending flawlessly with deep-rooted Arabian heritage and art.', image: 'https://source.unsplash.com/yB154qM/800x1000' },
    { id: 'jo', name: 'Jordan', description: 'The incredible rose-red city of Petra and the stark, beautiful landscapes of Wadi Rum.', image: 'https://source.unsplash.com/k9gOyu9K9FM/800x1000' },
    ...
    { id: 'my', name: 'Malaysia', description: 'A melting pot of cultures featuring the Petronas Towers and pristine Bornean rainforests.', image: 'https://source.unsplash.com/8ywrgMgVtlY/800x1000' },
    ...
    { id: 'lk', name: 'Sri Lanka', description: 'Lush tea plantations, ancient Buddhist ruins, and pristine Indian Ocean beaches.', image: 'https://source.unsplash.com/jpTT_SAU034/800x1000' },
    ...
    { id: 'nz', name: 'New Zealand', description: 'Unmatched adventure landscapes, soaring fjords, and welcoming native Maori culture.', image: 'https://source.unsplash.com/73F4pKoUkM0/800x1000' },
    ...
    { id: 'mx', name: 'Mexico', description: 'Ancient Mayan ruins, vibrant culinary scenes, and stunning resorts in the Riviera Maya.', image: 'https://source.unsplash.com/63mOjNg0Xu8/800x1000' },
    ...
    { id: 'ar', name: 'Argentina', description: 'The tango culture of Buenos Aires, premium wine regions, and the dramatic peaks of Patagonia.', image: 'https://source.unsplash.com/5RY2ggp0ykQ/800x1000' },
    { id: 'cl', name: 'Chile', description: 'From the stark beauty of the Atacama Desert to the frozen fjords of the south.', image: 'https://source.unsplash.com/0V_mQncw9fM/800x1000' },
    { id: 'pe', name: 'Peru', description: 'The mystical ruins of Machu Picchu, the Sacred Valley, and world-renowned gastronomy.', image: 'https://source.unsplash.com/yam1KMv0SgQ/800x1000' },
    { id: 'co', name: 'Colombia', description: 'Colorful colonial cities like Cartagena, rich coffee regions, and revitalized urban centers.', image: 'https://source.unsplash.com/acH94SHbWS4/800x1000' },
    ...
    { id: 'pa', name: 'Panama', description: 'A thriving modern capital, the famous canal, and pristine, undeveloped tropical islands.', image: 'https://source.unsplash.com/qeltMhQIw3w/800x1000' },
    { id: 'za', name: 'South Africa', description: 'Unforgettable Big Five safaris, spectacular coastal drives, and the beauty of Cape Town.', image: 'https://source.unsplash.com/FD4laNilvCU/800x1000' },
    { id: 'ma', name: 'Morocco', description: 'A sensory journey through colorful souks, the Sahara desert, and intricate riad architecture.', image: 'https://source.unsplash.com/jnJMtXFqCFY/800x1000' },
