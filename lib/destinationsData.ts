...
export const globalDestinations: DestinationItem[] = [
    ...
    { id: 'se', name: 'Sweden', description: 'Archipelagos of thousands of islands and the sophisticated design culture of Stockholm.', image: 'https://images.unsplash.com/photo-1441785074275-ef394d6f16b8?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'qa', name: 'Qatar', description: 'Futuristic skylines blending flawlessly with deep-rooted Arabian heritage and art.', image: 'https://images.unsplash.com/photo-1589456506629-b2ea1a8576f0?auto=format&fit=crop&q=80&w=800' },
    { id: 'jo', name: 'Jordan', description: 'The incredible rose-red city of Petra and the stark, beautiful landscapes of Wadi Rum.', image: 'https://images.unsplash.com/photo-1562679299-eba6a7d7d3a5?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'cl', name: 'Chile', description: 'From the stark beauty of the Atacama Desert to the frozen fjords of the south.', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&q=80&w=800' },
